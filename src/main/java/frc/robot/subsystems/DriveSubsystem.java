...
public class DriveSubsystem extends SubsystemBase {
  ...
  public static class Hardware{
    ...
    WPI_TalonSRX midlSlaveMotor;
    WPI_TalonSRX rMasterMotor;
    WPI_TalonSRX lSlaveMotor;
    WPI_TalonSRX midrSlaveMotor;
  ...
  public DriveSubsystem(Hardware drivetrainHardware) {
    ...
    this.m_midlSlaveMotor = drivetrainHardware.midlSlaveMotor;
    this.m_rMasterMotor = drivetrainHardware.rMasterMotor;
    this.m_lSlaveMotor = drivetrainHardware.lSlaveMotor;
    this.m_midrSlaveMotor = drivetrainHardware.midrSlaveMotor;
    ...
    m_midrSlaveMotor.setInverted(true);

    m_lSlaveMotor.follow(m_lMasterMotor);
    m_midlSlaveMotor.follow(m_lMasterMotor);
    m_rSlaveMotor.follow(m_rMasterMotor);
    m_midrSlaveMotor.follow(m_rMasterMotor);
  ...
  public static Hardware initializeHardware(){
    Hardware drivetrainHardware = new Hardware(
      ...
      new WPI_TalonSRX(Constants.DriveHardware.MIDDLE_LEFT_SLAVE_MOTOR),
      new WPI_TalonSRX(Constants.DriveHardware.MIDDLE_RIGHT_SLAVE_MOTOR),
